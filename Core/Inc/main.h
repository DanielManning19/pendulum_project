...
#define MOTOR_EN2_GPIO_Port GPIOC
...
#define ENCODER_TWO_Pin GPIO_PIN_4
#define ENCODER_TWO_GPIO_Port GPIOB
#define ENCODER_TWO_EXTI_IRQn EXTI4_IRQn
#define ENCODER_ONE_Pin GPIO_PIN_5
#define ENCODER_ONE_GPIO_Port GPIOB
#define ENCODER_ONE_EXTI_IRQn EXTI9_5_IRQn
#define MOTOR_EN3_Pin GPIO_PIN_6
